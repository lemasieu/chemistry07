...
document.getElementById('view-theory').addEventListener('click', () => {
  const pdfUrl = 'https://h-a-7.tiiny.site'; // Cập nhật link subdomain
  ...
  document.getElementById('submit').style.display = 'none';
  document.getElementById('next-question').style.display = 'none';
  console.log('Theory view opened with PDF');
});